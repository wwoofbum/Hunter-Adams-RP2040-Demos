...
#include <math.h>
#include <string.h>
// Include libraries to generate random numbers
#include <stdlib.h>
#include <time.h>
...
volatile unsigned int phase_incr_main_0 = (2400.0*two32)/Fs ;
...
volatile unsigned int CHIRP_STATE_0 = 0;
volatile unsigned int CHIRP_STATE_1 = 0;
volatile unsigned int syl_count_0 = 0;
volatile unsigned int syl_count_1 = 0;
...
static void alarm_irq_1(void) {
    ...
    if (CHIRP_STATE_1 == 0) {
        ...
        count_1 += 1;
        if (count_1 == (CHIRP_REPEAT_INTERVAL + 500)) {
            CHIRP_STATE_1 = 0;
            count_1 = 0;
            STATE_1 = 0;
            syl_count_1 = 0;
